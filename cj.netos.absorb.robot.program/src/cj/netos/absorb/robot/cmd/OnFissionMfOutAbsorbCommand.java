...
@CjConsumer(name = "from_fission_mf")
@CjService(name = "/robot/trade/settle.mq#outAbsorb")
public class OnFissionMfOutAbsorbCommand implements IConsumerCommand {
    @CjServiceRef
    IFissionMFOutAbsorbService fissionMFOutAbsorbService;
    @CjServiceRef
    ...
    public void command(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws RabbitMQException, RetryCommandException, IOException {
        ...
        AbsorbOutRecord record = new Gson().fromJson(json, AbsorbOutRecord.class);
        BankWithdrawResult result =record.convertResult();
        ...
        try {
            mutex.acquire();
            fissionMFOutAbsorbService.receive(result);
        } catch (Exception e) {
